...
public class RotatingPlanevAljaz extends JPanel implements Runnable, MouseWheelListener, MouseMotionListener, MouseListener{
    RotatingPlanevAljaz(){
        this.setLayout(null);
        ...
        for(int i=0; i<allLines.size() ; i++){
           ...
           /* int[] projectedZeroZ = new int[6];
            ...
            for(int j=0; j<lineLength; j+=1){
                ...
                int drawSize = startSize - (int)((double)finalDotCoordinates[j][2]/horizonPoint[2]*startSize)/2;
